#!/usr/bin/env bash
# Full pipeline: RIC restart → xApp container check → gNB+srsUE → Campaign A
set -euo pipefail
...
# ── 4. Campaign A ─────────────────────────────────────────────────────────────
log "=== Step 4/4: Campaign A ==="
bash /home/kgobi/thesis/run_campaign_A.sh

log ""
log "══ Pipeline complete ══"
log "Output: /home/kgobi/thesis/data/campaign_A_no_qos.csv"
wc -l /home/kgobi/thesis/data/campaign_A_no_qos.csv
